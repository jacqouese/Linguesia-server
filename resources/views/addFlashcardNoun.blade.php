    ...
    <form action="/flashcard" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-input-article form-control" placeholder="article" name="german_article">
                <span class="input-group-text"> </span>
                <input type="text" class="form-control" placeholder="word" name="german">
            </div>
        </div>
        <div>
